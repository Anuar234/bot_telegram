...
export default {
    ...
    try {
        ...
        const response = await fetch(`https://effective-computing-machine-7j6qr67xwr6cp99r-8000.app.github.dev/api/tasks/${user.id}`);
        ...
        async completeTask(taskId) {
            try {
                const response = await fetch(`https://effective-computing-machine-7j6qr67xwr6cp99r-8000.app.github.dev/api/completed`, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json'
                    },
